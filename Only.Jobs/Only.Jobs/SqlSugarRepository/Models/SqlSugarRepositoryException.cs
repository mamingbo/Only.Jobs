...
namespace SqlSugarRepository
{
    ...
    public class SqlSugarRepositoryException : Exception
    {
        ...
        public SqlSugarRepositoryException(string message, string sql, object pars)
        ...
        /// <param name="message">错误信息</param>
        /// <param name="pars">错误函数的参数</param>
        public SqlSugarRepositoryException(string message,object pars)
        ...
        private static string GetMessage(string message, object pars)
        {
            ...
            if (pars != null)
            {
                parsStr = new JavaScriptSerializer().Serialize(pars);
            }
        ...
        private static string GetMessage(string message, string sql, object pars)
        {
            ...
            {
                var reval = GetLineMessage("错误信息         ", message) + GetLineMessage("ORM生成的Sql", sql) + GetLineMessage("函数参数        ", new JavaScriptSerializer().Serialize(pars));
                return reval;
            }
        }
